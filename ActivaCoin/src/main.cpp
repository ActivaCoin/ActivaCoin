...
uint256 hashGenesisBlock("0x03f2e0f4627d6e2a560244dbc94b71961278d43263e548b3c6d86432e05cf920");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight == 2) // no block reward after 5 years
...
static const int64 nTargetTimespan = 10 * 60; // ActivaCoin: 10 Min
static const int64 nTargetSpacing = 5; // ActivaCoin: 5 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ActivaCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ActivaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "Caliente iTech's First Coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1505106785;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2087836715;
        ...
        assert(block.hashMerkleRoot == uint256("0x3cc04750d4259674b6119eb1fd2615883adbf2057269a344d0df670eac9c54d5"));
